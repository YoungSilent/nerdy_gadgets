    ...
    foreach($Result as $ResultKey => $ResultValue){
            ...
            <form method="post" action="cart.php">
                <label for="aantal"></label>Aantal: 
                    <input type="number" id="aantal" name="aantal<?php print($stockItemID);?>" min="1" value="<?php print($cart[$stockItemID]);?>" max="<?php echo str_replace("Voorraad: ","",$ResultValue['QuantityOnHand'] ) ?>">
            </form>
